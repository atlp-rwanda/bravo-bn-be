...
import { getAllNotifications, readAllNotification, readNotification } from '../../controllers/notificationController';
...
userRouter.delete('/notification/:id',protect,readNotification);
